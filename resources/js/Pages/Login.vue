...
<div id="app" class="flex items-center justify-center min-h-screen bg-gray-200">
    <div class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
        <div class="flex flex-col justify-center p-4 md:p-14">
            ...
            <p class="font-light text-gray-400 mb-8">Digite suas credenciais para acessar a calculadora.</p>
            <form
            @submit.prevent="form.post('/login-submit')" 
            action="" 
            method="POST"
            novalidate
            >
            ...
            <div class="py-4">
                <button type="submit" class="w-full bg-black text-white p-2 rounded-lg mb-6 hover:bg-white hover:text-black hover:border hover:border-gray-300">Entrar</button>
            </div>
            </form>
            <Link href="/signup" class="font-bold text-md">Cadastre-se</Link>
            </div>
        </div>
    </div>
</template>
